...
column1 = dbc.Col(
    [   
        ...
        dcc.Markdown(
            ...
            because a weightlifter, for example, will be way heavier than an athlete such as cycling who will be leaner. (Side note: when using the predictions page, when you move weight,
            this is why it changes the most, because its the most important feature.) It's interesting that sex is the least
            important feature.   
